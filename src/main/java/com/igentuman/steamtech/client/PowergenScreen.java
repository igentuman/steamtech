...
import com.igentuman.steamtech.blocks.PowergenContainer;
...
public class PowergenScreen extends AbstractContainerScreen<PowergenContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(SteamTech.MODID, "textures/gui/powergen_gui.png");
