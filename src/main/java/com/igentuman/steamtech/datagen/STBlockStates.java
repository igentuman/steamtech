...
import static com.igentuman.steamtech.client.GeneratorModelLoader.GENERATOR_LOADER;

public class STBlockStates extends BlockStateProvider {

    public STBlockStates(DataGenerator gen, ExistingFileHelper helper) {
        super(gen, SteamTech.MODID, helper);
    }
